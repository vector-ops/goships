...
func main() {
	...
	gc.InitPair(types.WHITE_BLACK, gc.C_WHITE, gc.C_BLACK)
	gc.InitPair(types.RED_BLACK, gc.C_RED, gc.C_BLACK)
	gc.InitPair(types.GREEN_BLACK, gc.C_GREEN, gc.C_BLACK)
	gc.InitPair(types.BLUE_BLACK, gc.C_BLUE, -1)
	gc.InitPair(types.YELLOW_BLACK, gc.C_YELLOW, gc.C_BLACK)
	gc.InitPair(types.MAGENTA_BLACK, gc.C_MAGENTA, gc.C_BLACK)
	gc.InitPair(types.CYAN_BLACK, gc.C_CYAN, gc.C_BLACK)
